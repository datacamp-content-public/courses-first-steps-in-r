...
success_msg("")
ex() %>% check_output(3, fixed=TRUE, missing_msg="Leider nicht richtig, dies ist für R kein Problem!")
success_msg("")
ex() %>% check_output(4, fixed=TRUE, missing_msg="Leider nicht richtig, unterschiedliche Datentypen lassen sich nicht einer Matrix speichern. Überlegen Sie noch einmal!")
success_msg("")
```
